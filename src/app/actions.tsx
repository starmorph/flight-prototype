...
export async function continueTextConversation(messages: CoreMessage[]) {
  try {
    console.log('Starting streamText with messages:', messages);
...
---`;
            ...
            return `Found ${filteredFlights.length} flight${filteredFlights.length > 1 ? 's' : ''}:\n\n${results}`;
          },
        },
      },
    });
    ...
    console.error('Error in continueTextConversation:', error);
    const errorStream = createStreamableValue('Sorry, I encountered an error. Please try again.');
